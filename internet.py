...
def obtener_datos_api():
    ...
    # --- DATOS DEL CREADOR Y SU FAMILIA ---
    familia_creador = (
    ...
    # --- API DEL DÓLAR ---
    try:
        req = requests.get("https://dolarapi.com/v1/dolares/blue", timeout=5)
        datos = req.json()
    ...
    try:
        req_clima = requests.get("https://wttr.in/San+Martin,Mendoza?format=%t", timeout=4)
    ...
    try:
        req_news = requests.get("https://news.google.com/rss?hl=es-419&gl=AR&ceid=AR:es-419", timeout=5)

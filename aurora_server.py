...
# Intentamos cargar internet.py si existe
try:
    import internet
...
# Memoria dinámica de la conversación
historial_memoria = [] 
...
def chat():
    ...
    # Buscamos la llave de Google
    API_KEY = os.environ.get("GEMINI_API_KEY")
    if not API_KEY:
        return jsonify({"respuesta": "Falta configurar la llave GEMINI_API_KEY."})
    ...
    try:
        ...
        # Construcción de la memoria (Últimos 6 mensajes para fluidez)
        contenidos = []
        ...
        # Realizamos la petición a Google
        ...
        print(f"ERROR: {e}")
        respuesta_ai = "Perdón, tuve un pequeño problema de conexión. ¿Podés repetir?"
